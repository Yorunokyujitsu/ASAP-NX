...
> **XorTroll** and **Slluxx** - [Homebrew](https://github.com/Slluxx/AmiiboGenerator) and [system module](https://github.com/XorTroll/emuiibo) for managing virtual amiibo.<br>
